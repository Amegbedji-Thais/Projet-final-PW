...
final class Version20230108153552 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE biens (id INT AUTO_INCREMENT NOT NULL, categorie_id INT NOT NULL, type_bien VARCHAR(255) NOT NULL, titre_bien VARCHAR(255) NOT NULL, surface_bien VARCHAR(255) NOT NULL, prix_bien INT NOT NULL, localisation_bien VARCHAR(255) NOT NULL, description_bien LONGTEXT NOT NULL, image VARCHAR(255), desc_bien LONGTEXT NOT NULL, INDEX IDX_1F9004DDBCF5E72D (categorie_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
