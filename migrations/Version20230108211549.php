 ...
 */
final class Version20230108211549 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE admin ADD roles VARCHAR(60) NOT NULL');
        $this->addSql('ALTER TABLE biens DROP desc_bien');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE favoris_biens (favoris_id INT NOT NULL, biens_id INT NOT NULL, INDEX IDX_CCF577BC51E8871B (favoris_id), INDEX IDX_CCF577BC7773350C (biens_id), PRIMARY KEY(favoris_id, biens_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE biens ADD desc_bien LONGTEXT NOT NULL');
